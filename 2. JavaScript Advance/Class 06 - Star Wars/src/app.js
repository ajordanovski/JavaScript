let navigationService = {
    ...
    fistBtn: document.getElementById("firstBtn"),
    ...
    init: function () {
        ...
        this.fistBtn.addEventListener("click", function () {
        ...
        this.lastBtn.addEventListener("click", function () {
            ...
            uiService.toggleLoader(true);
            navigationService.currentPage = navigationService.lastPageNum;

            if (navigationService.pageType === "people") {
                //navigationService.currentPage = 9;
                starWarsService.getPeople(navigationService.currentPage);
            }
            if (navigationService.pageType === "ships") {
                //navigationService.currentPage = 4;
                starWarsService.getShips(navigationService.currentPage);
            }
    ...
    togglePagingButtons: function (response) {
        ...
        if (response.previous === null) {
            ...
            this.fistBtn.style.display = "none";
        } else {
            this.prevBtn.style.display = "block";
            this.fistBtn.style.display = "block";
        }
    },

    lastPage: function (response){
        this.lastPageNum = Math.ceil(response / 10);
    ...
    getPeople: function (page) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                navigationService.lastPage(response.count);
    ...
    getShips: function (page) {
        ...
        fetch(shipUrl)
            ...
            .then(data => {
                ...
                navigationService.lastPage(data.count);
                uiService.toggleLoader(false);
            })
